...
2026-06-04 lint → первый проход lint vault'а. Починены broken-links: [[competitors]] (переименовал `entities/competitors/index.md` → `entities/competitors.md`, чтобы резолвилось по basename), [[entities/competitors]] в [[0001-warmup-content]] → [[competitors]], [[capture-knowledge]] в [[learnings]] → текстовое упоминание скилла, [[raw/interviews/...]] и [[posts/]] в [[hook-formulas]]/[[proof-points]] → пути без двойных скобок (placeholder'ы, не страницы), planned-страницы trainer-blogger/dzen/seo в [[index]] → без скобок до их создания. Orphan'ов нет, противоречий с hard contracts не нашёл, outdated frontmatter не нашёл (порог 60 дней — vault моложе). (Steve, PR)
