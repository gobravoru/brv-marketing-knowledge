...
2026-05-30 lint — fixed 6 broken wikilinks (raw-refs → markdown, capture-knowledge → текст skill, [[posts/]] / [[raw/interviews/...]] → текст); renamed [[entities/competitors/index]] → [[competitors]]; убран [[trainer-blogger]] из index (страницы нет). Flagged 3 hard-contract файла ([[positioning]], [[brand-voice]], [[proof-points]]) — содержат wikilinks на raw-доки ([[raw/product-docs/bravo-product]], [[raw/product-docs/target-audience]], [[bravo-product]], [[raw/interviews/...]]), не правлю без approve. PR `claude/determined-curie-al6yV`. (Steve)
